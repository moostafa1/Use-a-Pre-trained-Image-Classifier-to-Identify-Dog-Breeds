...
def calculates_results_stats(results_dic):
    ...
    for img in results_dic:
        n_match +=  results_dic[img][2]
        n_dogs_img += results_dic[img][3]
        n_correct_dogs += 1 if sum(results_dic[img][3:]) == 2 else 0
        n_correct_notdogs += 1 if sum(results_dic[img][3:]) == 0 else 0
        n_correct_breed += 1 if sum(results_dic[img][2:]) == 3 else 0
    ...
    # percentage of correctly classified dog breed
...
if __name__ == "__main__":
    ...
    results_stats_dic = calculates_results_stats(image_label_dic)
